              ...
              <div className="col-lg-5">
                ...
                <div className="text-wrapper">
                  ...
                  <p>
                    ...
                    processes of the educational enterprises of varying sizes in
                    an efficient manner. All the aspects of the administrative
                    domain are ably backed by the ShikshaPlus ERP System which
                    is an easy to use and affordable solutions provider to an
                    ...
                    <div className="features-block theme-one wow fadeInUp">
                      <div className="inner-box">
                        ...
                        <div className="text">
                          ...
                          <p>
                            It incorporates seamless trasition from the complex
                            manual interventions into the digital mode.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="inner-box">
                        ...
                        <div className="text">
                          ...
                          <p>
                            ...
                            everything they need to online, from anywhere in the
                            world.
                          </p>
                        </div>
                      </div>
                ...
                <div className="heading-wrapper text-center">
                  ...
                  <div className="lead-text">
                    <p>
                      ...
                      Software. It provides the excellent way to systematically
                      operate the school. It automates all your to-do activities
                      such as managing Administration, Academics, Teachers and
                      students.
                    </p>
                  </div>
                </div>
                ...
                <div className="features-block theme-two wow fadeInUp">
                  <div className="inner-box">
                    <div className="text">
                      ...
                      <p>
                        Efficient data management, easy to use and accessibility
                        along with the optimal utilization of available
                        resources are the hallmark of our Shiksha Plus ERP
                        system.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="inner-box">
                    <div className="text">
                      ...
                      <p>
                        {" "}
                        The stakeholders can access the software from any remote
                        locations. They just need to coome up with the online
                        credentials of the online educational ERP portal.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="inner-box">
                    <div className="text">
                      ...
                      <p>
                        Shiksha Plus are very apt in managing and storing large
                        amount of complex data online with minimum fuss. It
                        significantly reduces data compilation and storage
                        physically.
                      </p>
                    </div>
                  </div>
                ...
                <div className="heading-wrapper with-separator text-center">
                  ...
                  <div className="lead-text">
                    <p>
                      ...
                      management, campus recruitment, account management, staff
                      management, transport management and many more. Some core
                      modules that school management software comes with are
                      listed here:-
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-12">
                <div className="ss-wrapper">
                  ...
                  <div className="screenshot-slider text-center">
                    ...
                    <div className="item">
                      <Image
                        src={require("../../public/images/sp5.png")}
                        alt="logo"
                        width={600}
                        height={460}
                      />
